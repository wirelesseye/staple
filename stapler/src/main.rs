    ...
    fn runs_mutable_bindings_captures_and_refs() {
        ...
        std::fs::write(
            ...
            concat!(
                ...
                "def release = () => { var resource = Resource 1; resource = Resource 2 }\n",
                "def abandon = () => { var resource = Resource 4; let update = () => { resource = Resource 5 }; update () }\n",
